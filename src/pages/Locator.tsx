        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[700px]">
          ...
          <div className="lg:col-span-1 bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col">
            <div className="p-8 bg-drpepper-maroon text-white">
              <h1 className="text-3xl font-black italic transform -skew-x-12 mb-6 uppercase">Find Dr Pepper</h1>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-xl py-4 pl-12 pr-4 text-white placeholder:text-white/50 outline-none focus:bg-white/20 transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {mockStores.map((store, i) => (
                <motion.div 
                  ...
                  className="p-6 rounded-2xl border border-drpepper-cream hover:border-drpepper-red hover:shadow-md transition-all cursor-pointer group"
                >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                      <button className="p-2 rounded-full bg-drpepper-cream text-drpepper-maroon hover:bg-drpepper-maroon hover:text-white transition-colors">
                        <Phone size={16} />
                      </button>
                      <button className="p-2 rounded-full bg-drpepper-cream text-drpepper-maroon hover:bg-drpepper-maroon hover:text-white transition-colors">
                        <Navigation size={16} />
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl overflow-hidden relative">
            <div className="absolute inset-0 bg-[#e5e3df]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-drpepper-maroon/20 font-black text-8xl italic transform -skew-x-12 select-none">MAP VIEW</div>
              </div>
            ...
            <div className="absolute bottom-8 right-8 flex flex-col space-y-2">
              <button className="w-12 h-12 bg-white rounded-xl shadow-lg flex items-center justify-center text-drpepper-maroon hover:bg-drpepper-cream transition-colors font-bold text-xl">+</button>
              <button className="w-12 h-12 bg-white rounded-xl shadow-lg flex items-center justify-center text-drpepper-maroon hover:bg-drpepper-cream transition-colors font-bold text-xl">-</button>
            </div>
            
            <div className="absolute top-8 right-8">
              <button className="bg-white px-6 py-3 rounded-full shadow-lg flex items-center space-x-2 text-drpepper-maroon font-bold uppercase tracking-widest text-xs hover:bg-drpepper-cream transition-colors">
                <Navigation size={16} />
