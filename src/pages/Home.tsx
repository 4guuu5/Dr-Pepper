      ...
      <section className="py-24 bg-drpepper-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-16">
            <div>
              <h2 className="text-4xl md:text-5xl font-black text-drpepper-maroon italic transform -skew-x-12 mb-4">
                THE LINEUP
              </h2>
              <p className="text-drpepper-maroon/60 font-bold uppercase tracking-widest">Find your perfect match</p>
            </div>
            <Link to="/flavors" className="text-drpepper-maroon font-bold uppercase tracking-widest hover:text-drpepper-red transition-colors flex items-center">
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden rounded-3xl mb-6">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                    <p className="text-white font-bold italic mb-2">{flavor.tagline}</p>
                    <button className="text-white text-sm font-bold uppercase tracking-widest flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-black text-drpepper-maroon italic transform -skew-x-12 mb-8 leading-tight">
                GET REWARDED FOR<br />
              ...
              <Link to="/perks" className="btn-primary inline-block">
                Start Earning Now
              </Link>
            </div>
              ...
              <div key={item.id} className="bg-white rounded-3xl overflow-hidden group shadow-sm hover:shadow-xl transition-shadow">
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="w-12 h-12 rounded-full bg-drpepper-maroon text-white flex items-center justify-center hover:bg-drpepper-red transition-colors">
                      <ShoppingBag size={20} />
                    </button>
                  </div>
                </div>
